...
export class UsuarioService {
 ...
 cargar_storage(){
  ...
  // dominios(tipo){
  //   this.headers['Authorization'] = "Basic " + btoa((this.getUser().user + ':' + this.getUser().password));
  //   let sr = "<soapenv:Envelope [env]:soapenv='http://schemas.xmlsoap.org/soap/envelope/' [env]:max='http://www.ibm.com/maximo'>"+
...
//                 <max:CLASS maxvalue="?">SR</max:CLASS>
//                 <max:DESCRIPTION changed="?">PRUEBA JG VIALIDAD 2021-12-31T20:15:29.064Z</max:DESCRIPTION>
//                 <max:DESCRIPTION_LONGDESCRIPTION changed="?">Prueba</max:DESCRIPTION_LONGDESCRIPTION>
//                 <max:FECHARE changed="?">2021-07-03T21:15:29.064Z</max:FECHARE>
//                 <max:CATEGORIAMOP changed="?">Leve</max:CATEGORIAMOP>
//                 <max:REPORTDATE>2021-07-03T21:15:29.064Z</max:REPORTDATE>
//                 <max:LOCATION changed="?"></max:LOCATION>
//                 <max:TRANSITO changed="?">Interrumpido</max:TRANSITO>
//                 <max:ELEMENTO changed="?"></max:ELEMENTO>
//                 <max:COMPETENCIA changed="?">No</max:COMPETENCIA>
//                 <max:EVENTO changed="?"> </max:EVENTO>
//                 <max:APUNTALAR changed="?">False</max:APUNTALAR>
//                 <max:ALZAPRIMAR changed="?">False</max:ALZAPRIMAR>
//                 <max:REMOVER changed="?">0</max:REMOVER>
...
//                    <max:DOCTYPE changed="?">Attachments</max:DOCTYPE>
//                    <!--Optional:-->
//                    <max:DOCUMENT changed="?">Prueba 1</max:DOCUMENT>
//                    <!--Optional:-->
//                    <max:DOCUMENTDATA changed="?">dGVzdA0K</max:DOCUMENTDATA>
//                    <!--Optional:-->
//                    <max:OWNERTABLE changed="?">SR</max:OWNERTABLE>
//                    <!--Optional:-->
//                    <max:UPLOAD changed="?">1</max:UPLOAD>
...
//  `
//     const options: HttpOptions = {
//       url:URL_SERVICIOS + "MOP_WS_MOP_SR_EMER_DOH",
//       data:sr,
//       headers:this.headers
//     };
//     console.log(sr)
...
//   }
  ...
  //                         <!--Zero or more repetitions:-->
  //                         <max:REGION >`+this.usuario.PERSON.STATEPROVINCE+`</max:REGION>
  //                         <!--Zero or more repetitions:-->
  //                         <max:SITEID operator="=" >`+this.usuario.DEFSITE+`</max:SITEID>
  //                         <!--Zero or more repetitions:-->
  ...
  //         </soapenv:Envelope>
  //         `
  //   let url = this.URL_SERVICIOS+'MOP_WS_MOP_ASSET_DOH';
  //   const options: HttpOptions = {
  //     url:url,
  //     data:sr,
  //     headers:this.headers
...
//       password:'bar09roj06'
//     }
//     this.headers['Authorization'] = "Basic " + btoa(unescape(encodeURIComponent(data.user + ':' + data.password)));
...
//                 <max:AFFECTEDPERSON changed="?">MAXIMO.EMRDV</max:AFFECTEDPERSON>
//                 <!--camino/activo al cual tiene permiso el usuario:-->
//                 <max:ASSETNUM changed="?">65D20901</max:ASSETNUM>
//                 <!--opcional Elemento, se selecciona-->
//                 <max:ELEMENTO changed="?">Pisos</max:ELEMENTO>
               
//                <!--Direccion a la que pertenece el usuario:-->
//                 <max:ASSETSITEID changed="?">VIALIDAD</max:ASSETSITEID>
//                 <!--Nivel de Gravedad:-->
//                 <max:CATEGORIAMOP changed="?">Moderado</max:CATEGORIAMOP>
//                 <!-- Competencia, con predeterminado debe ser SI-->
//                 <max:COMPETENCIA changed="?">Si</max:COMPETENCIA>
//                 <!--Resumen de Emergencia:-->
//                 <max:DESCRIPTION changed="?">Resumen de EmergenciA</max:DESCRIPTION>
//                 <!--descripcion detallada:-->
//                 <max:DESCRIPTION_LONGDESCRIPTION changed="?">descriipcion de detallada</max:DESCRIPTION_LONGDESCRIPTION>
              
//                 <!--Fecha Emergencia :-->
//                 <max:FECHARE changed="?">2021-10-07T21:46:27-00:00</max:FECHARE>
//                 <!--Fecha ingreso - fecha actual:-->
//                 <max:REPORTDATE changed="?">2021-10-07T21:46:27-00:00</max:REPORTDATE>
//                 <!-- Digitado por:-->
//                 <max:REPORTEDBY changed="?">MAXIMO.EMRDV</max:REPORTEDBY>
//                 <!--Transito:-->
//                 <max:TRANSITO changed="?">Con Restricción</max:TRANSITO>
//                 <!--Restriccion, es obligatorio si el Transito es Con Restriccion:-->
//                 <max:RESTRICCION changed="?">Horario Restringido</max:RESTRICCION>
//                 <!-- Valor fijo para Vialidad:-->
//                 <max:TIPOTRAB changed="?">ME</max:TIPOTRAB>
//                 <max:TKSERVICEADDRESS action="AddChange" relationship="?" deleteForInsert="?">
//                    <!-- Region del usuario que esta generando-->
//                    <max:REGIONDISTRICT changed="?">05</max:REGIONDISTRICT>
//                 </max:TKSERVICEADDRESS>            
//                 <!-- registro de camino :-->
//                 <max:MULTIASSETLOCCI action="Add" >
//                    <!--Camino / Activo seleccionado :-->
//                    <max:ASSETNUM changed="?">65D20901</max:ASSETNUM>
//                    <!--Km fin Segmento Ingresado:-->
//                    <max:ENDMEASURE changed="?">1</max:ENDMEASURE>
//                    <!--Km Inicio Segmento Ingresado:-->
//                    <max:STARTMEASURE changed="?">0</max:STARTMEASURE>
//                 </max:MULTIASSETLOCCI>
//                 <max:DOCLINKS action="AddChange">
//                    <!--Optional:-->
//                    <max:ADDINFO changed="?">1</max:ADDINFO>
...
//                    <max:COPYLINKTOWO changed="?">0</max:COPYLINKTOWO>
//                    <!--Optional:-->
//                    <max:DESCRIPTION changed="?">ALERTA </max:DESCRIPTION>
//                    <!--Optional:-->
//                    <max:DOCTYPE changed="?">Attachments</max:DOCTYPE>
//                    <!--Optional:-->
//                    <max:DOCUMENT changed="?">foto</max:DOCUMENT>
//                    <!--Optional:-->
//                    <max:DOCUMENTDATA changed="?">ABAQAAA</max:DOCUMENTDATA>
//                    <!--Optional:-->
//                    <max:OWNERTABLE changed="?">SR</max:OWNERTABLE>
//                    <!--Optional:-->
//                    <max:UPLOAD changed="?">1</max:UPLOAD>
...
// //          <!--Zero or more repetitions:-->
// //          <max:SR action="Add">
// //          <max:ASSETSITEID>DAP</max:ASSETSITEID>
// //             <max:STATUS maxvalue="?">NUEVO</max:STATUS>
// //             <max:SRTIPO maxvalue="?">E</max:SRTIPO>
// //             <max:LOCATION maxvalue="?">SCSE</max:LOCATION>
// //             <max:ASSETNUM maxvalue="?"></max:ASSETNUM>
// //             <max:CLASS maxvalue="?">SR</max:CLASS>
// //             <max:DESCRIPTION changed="?">PRUEBA APP NO TOMAR ENCUENTA DAP</max:DESCRIPTION>
// //             <max:DESCRIPTION_LONGDESCRIPTION changed="?">PRUEBA APP NO TOMAR ENCUENTA DAP</max:DESCRIPTION_LONGDESCRIPTION>
// //             <max:FECHARE changed="?">2022-07-03T21:15:29.064Z</max:FECHARE>
// //             <max:CATEGORIAMOP changed="?">Muy Grave</max:CATEGORIAMOP>
// //             <max:REPORTDATE>2022-08-26T21:15:29.064Z</max:REPORTDATE>
// //             <max:TRANSITO changed="?"></max:TRANSITO>
// //             <max:ELEMENTO changed="?"></max:ELEMENTO>
// //             <max:COMPETENCIA changed="?"></max:COMPETENCIA>
// //             <max:EVENTO changed="?"> </max:EVENTO>
...
// //             <max:TKSERVICEADDRESS action="AddChange">
// //                 <max:CITY changed="?">La Serene</max:CITY>
// //                 <max:COUNTRY changed="?">CL</max:COUNTRY>
// //                 <max:COUNTY changed="?">040101</max:COUNTY>
// //                 <max:LATITUDEY changed="?">-33.0823367285638</max:LATITUDEY>
// //                <max:LONGITUDEX changed="?">-70.86181640625</max:LONGITUDEX>
// //                 <max:REFERENCEPOINT changed="?">en la esquina</max:REFERENCEPOINT>
// //                 <max:REGIONDISTRICT changed="?">16</max:REGIONDISTRICT>
// //                 <max:STATEPROVINCE changed="?">0401</max:STATEPROVINCE>
// //                 <max:STREETADDRESS changed="?">123ed</max:STREETADDRESS>
// //                 <max:ADDRESSLINE2 changed="?">1</max:ADDRESSLINE2>
// //                 <max:ADDRESSLINE3 changed="?"></max:ADDRESSLINE3>
...
//     let url = this.URL_SERVICIOS+'MOP_WS_MOP_SR_EMER_DOH';
//     const options: HttpOptions = {
//       url:url,
//       data:sr,
//       headers:this.headers
