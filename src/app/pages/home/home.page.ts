...
export class HomePage implements OnInit,AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    this.nivelAlerta();
    this.activos();
    var stgo = olProj.transform([-70.673676, -33.447487], 'EPSG:4326', 'EPSG:3857')
    var iconFeature = new Feature({
        geometry: new Point(stgo),
        name: 'Mi ubicación'
    });
    ...
    var marker = new Feature(new Point(olProj.transform([-70.673676, -33.447487], 'EPSG:4326', 'EPSG:3857')));
    markers.getSource().addFeature(marker);
    this.Map2.addLayer(markers);
...
//   });
//   var  view = new View({
//     center: [36.85119033, -1.29393749],
//       zoom: 5
//   });
//   this.Map2 = new Map({
//     target: 'map',
//     // controls: [new ol.control.FullScreen(), new ol.control.Zoom(), new ol.control.Control({ element: testElement })],
//     layers: [
//               new TileLayer({
//           source: new OSM()
//         })
